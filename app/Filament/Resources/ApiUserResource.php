        ...
        return $table
            ...
            ->actions([
                Action::make('generate')
                        ...
                        Notification::make()
                            ...
                            ->actions([
                                \Filament\Notifications\Actions\Action::make('copy')
                                    ...
                                    ->button()
                                    ->color('primary')
                                    ->action(function () use ($apiKey, $apiSecret) {
                    ...
                    ->modalHeading('Generate New API Keys')
                    ->modalDescription('Are you sure you want to generate new API keys? This will invalidate any existing keys.')
                    ->modalSubmitActionLabel('Yes, generate new keys'),
                ...
                Action::make('revoke')
                    ...
                    ->action(function (ApiUser $record): void {
                        ...
                        Notification::make()
                            ...
                            ->body('The API keys have been successfully revoked.')
                            ->success()
                            ->send();
                    })
                    ->requiresConfirmation()
                    ->modalHeading('Revoke API Keys')
                    ->modalDescription('Are you sure you want to revoke these API keys? This action cannot be undone.')
                    ->modalSubmitActionLabel('Yes, revoke keys'),
            ])
            ->bulkActions([
                Tables\Actions\BulkAction::make('revoke')
                    ...
                    ->action(function (Collection $records): void {
                        ...
                        Notification::make()
                            ->title('Bulk API Keys Revocation')
                            ->body('Selected API keys have been successfully revoked.')
                            ->success()
                            ->send();
                    })
                    ->requiresConfirmation()
                    ->modalHeading('Revoke Multiple API Keys')
                    ->modalDescription('Are you sure you want to revoke the API keys for all selected users? This action cannot be undone.')
                    ->modalSubmitActionLabel('Yes, revoke all selected'),
            ])
            ->headerActions([
